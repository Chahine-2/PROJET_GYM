...
gboolean supprimer_confirme1 = FALSE;

void
on_check_supprimer_centre_toggled      (GtkToggleButton *togglebutton,
                                        gpointer         user_data)
{
  supprimer_confirme1 = gtk_toggle_button_get_active(togglebutton);
}
                                        ...
                                        gpointer         user_data)
{
    ...
    gtk_widget_show(window_navigation_entraineur);
}
...
void
on_btn_window_rechercher_centre_clicked(GtkButton *button, gpointer user_data)
{
                                        ...
                                        gpointer         user_data)
{
    ...
    if(res == 1) {
	 gtk_widget_hide(window9);
        ...
        {
            gtk_widget_show(window_navigation);          // admin GUI
        }
        else if(strcmp(u.role, "ENTRAINEUR") == 0)
        {
            gtk_widget_show(window_navigation_entraineur);          // trainer GUI
	    /*GtkWidget *tv = lookup_widget(window6, "treeview_inscription");
            afficher_inscriptions(tv);
   	    char centres[50][100];
        ...
        {
            gtk_widget_show(window20);          // member GUI
        }
